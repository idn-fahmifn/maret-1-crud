                ...
                <div class="overflow-x-auto mb-6 px-6">
                    <table class="min-w-full bg-white dark:bg-gray-800">
                        <tr>
                            ...
                            <td>
                                <img src="{{asset('storage/images/kategori/' . $data->thumbnail)}}" width="100" alt="">
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="mb-6 px-6">
                    <form action="{{route('kategori.update',$data->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="file" name="thumbnail" value="{{$data->thumbnail}}" class="block w-full bg-white dark:bg-transparent text-gray-800 mt-1 dark:text-gray-200 rounded-md">
                        </div>
                        <div class="mt-4">
